...
code_type=2; % 1) area_controlled condition; 2) size_controlled condition
...
if code_type==1
    ...
    for sample_i=1:number_of_samples
        ...
        bot_grid=[bot_grid(:,1)+xsize/2-box_size/2, bot_grid(:,2)+ysize/2+gap];%
        ...
        rectangle('Position', [xsize/2-box_size/2,ysize/2+gap, box_size, box_size],'FaceColor',color,'EdgeColor',color);
        ...
        top_grid=[top_grid(:,1)+xsize/2-box_size/2, top_grid(:,2)+ysize/2-gap-box_size];
        ...
        rectangle('Position', [xsize/2-box_size/2,ysize/2-gap-box_size, box_size, box_size],'FaceColor',color,'EdgeColor',color); %rectangle location
...
elseif code_type==2
    ...
    for sample_i=1:number_of_samples
        ...
        top_grid=[top_grid(:,1)+xsize/2-box_size/2, top_grid(:,2)+ysize/2-box_size-gap];
        ...
        rectangle('Position', [xsize/2-box_size/2,ysize/2-box_size-gap, box_size, box_size],'FaceColor',color,'EdgeColor',color); %rectangle location
        for i=1:top_dot_num(sample_i)
        ...
        frm = getframe( f );
        imwrite( frm.cdata,['Exp2_DotStim/' fnames{sample_i} '.png'] );
